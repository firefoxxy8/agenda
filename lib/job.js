...
{
  if (!this.attrs.lastRunAt || !this.attrs.lockedAt) return false;
  ...
  if (this.attrs.lockedAt && this.attrs.lockedAt.getTime() > this.attrs.lastFinishedAt.getTime()) return true;
  return false;
};

Job.prototype.isLockedByRunningProcess = function()
{
  return this.attrs.lockedByProcess === process.pid;
};
